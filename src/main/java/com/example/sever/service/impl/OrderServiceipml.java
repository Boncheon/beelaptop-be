...
public class OrderServiceipml implements OrderService {
    ...
    public OrderRespone taoDonHang(OrderRequest request) {
        ...
        for (int i = 0; i < 6; i++) ord.append(random.nextInt(10));

        StringBuilder mdh = new StringBuilder("MDH");
        for (int i = 0; i < 6; i++) mdh.append(random.nextInt(10));
        ...
        if (phieu != null) {
            ...
            for (int i = 0; i < 6; i++) gg.append(random.nextInt(10));
            ...
            // NOTE: tên field này của bạn hơi “lạ”
            // nếu "soTienTruocGiam" là tiền trước giảm thì nên set = order.getGiaTriChuaGiam()
            // còn nếu là tiền giảm thì set = soTienGiam
